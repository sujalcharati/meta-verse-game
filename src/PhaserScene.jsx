...
class PhaserScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('grass', 'public/grass.png'); // Update with your actual tileset path
    this.load.tilemapTiledJSON('grass-game', 'public/grass-game.json'); // Update with your actual map path
  }
